...
!		1 -> phi1* = phi_r1smth( )*phi_r1smth( )*phi_r1smth
!		2 -> phi2* = phi_r2smth( )*phi_r2smth( )*phi_r2smth
!		3 -> phi3* = phi_r3smth( )*phi_r3smth( )*phi_r3smth
!		4 -> phi4* = phi_r4smth( )*phi_r4smth( )*phi_r4smth
! 		5 -> phi3 = phi_r3 ( )*phi_r3 ( )*phi_r3 
!		6 -> phi4 = phi_r4( )*phi_r4( )*phi_r4
!		7 -> C6spline = spline_33( )*spline_33( )*spline_33

!	Double precision	function spline_33

!		To use this functions select shape variavle = 7 in  line 7 of geo.for


!	Double precision	function phi_r1smth(r)

!		To use this functions select shape variavle = 1 in  line 7 of geo.for


!	Double precision	function phi_r2smth(r)

!		To use this functions select shape variavle = 2 in  line 7 of geo.for


!       Double precision function phi_r3(r)

!			To use this functions select shape variavle = 5 in  line 7 of geo.for


!       Double precision function phi_r3smth2(r)

!			To use this functions select shape variavle = ??? in  line 7 of geo.for


!       Double precision function phi_r3smth(r)

!			To use this functions select shape variavle = 3 in  line 7 of geo.for


!   	Double precision function phi_r4(r)

!			To use this functions select shape variavle = 6 in  line 7 of geo.for


!       Double precision function phi_r4smth(r)

!				To use this functions select shape variavle = 4 in  line 7 of geo.for


!       Double precision function dh(dx,dy,dz,xij,yij,zij,Xl,Yl,Zl,order)

!				This function is a wrap for selecting the delta functions and splines defined throughout  this file based on the value of "order":

!					order = 1 -> phi1* = phi_r1smth( )*phi_r1smth( )*phi_r1smth
!							 nxl=1.499999d0  	; nl=27

!					order =	2 -> phi2* = phi_r2smth( )*phi_r2smth( )*phi_r2smth
!							 nxl=2.499999d0 	; nl=125	

!					order =	3 -> phi3* = phi_r3smth( )*phi_r3smth( )*phi_r3smth
!							 nxl=1.999999d0  	; nl=64 

!					order =	4 -> phi4* = phi_r4smth( )*phi_r4smth( )*phi_r4smth
!							 nxl=2.499999d0 	; nl=125

!					order = 5 -> phi3 = phi_r3 ( )*phi_r3 ( )*phi_r3 
!							 nxl=1.499999d0  	; nl=27

!					order =	6 -> phi4 = phi_r4( )*phi_r4( )*phi_r4
!							 nxl=1.999999d0  	; nl=64 

!					order =	7 -> C6spline = spline_33( )*spline_33( )*spline_33
!							 nxl=2.499999d0 	; nl=125	
...
!			Implements an intepolation function based on the Moving Least Square approach with weights based on a gaussian distribution.



!      subroutine kerneltododer(W,dX1,dY1,dZ1,difx,dify,difz,hx,hy,hz,neignum,kwx1,kwx2,kwy1,kwy2,kwz1,kwz2,MAXNEIG)
